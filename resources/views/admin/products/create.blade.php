    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_increase_by') ? 'is-invalid' : '' }}" type="number" name="price_increase_by" id="price_increase_by" value="{{ old('price_increase_by', '1') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_price') ? 'is-invalid' : '' }}" type="number" name="current_price" id="current_price" value="{{ old('current_price', '') }}" step="0.01">
